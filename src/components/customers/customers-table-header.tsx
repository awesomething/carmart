	...
	return (
		<TableHeader>
			<TableRow className="hover:bg-transparent border-primary-800">
				<TableHead className="text-gray-500 w-[80px]">
					<div
				...
				<TableHead className="text-gray-500 w-[150px]">
					<div
						className="flex items-center gap-2 cursor-pointer"
				...
				<TableHead className="text-gray-500 max-w-[150px]">Classified</TableHead>
				...
				<TableHead className="text-gray-500 w-[100px]">Actions</TableHead>
			</TableRow>
		</TableHeader>
	);
};