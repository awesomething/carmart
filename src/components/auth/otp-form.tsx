...
export const OtpForm = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex w-full flex-1 justify-center px-6 pt-10 lg:items-center lg:pt-0 bg-gray-800">
      <div className="flex w-full max-w-lg flex-col">
        <h3 className="mb-4 text-4xl lg:text-5xl text-center">
          One Time Password
        </h3>
        <p className="mb-12 text-center text-slate-200">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="flex w-full items-center justify-center">
              <button
                type="button"
                className="flex items-centewr gap-2.5 text-base font-medium text-slate-200 transition-colors duration-200 hover:text-primary group cursor-pointer"
                onClick={sendCode}
