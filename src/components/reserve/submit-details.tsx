						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormControl>
										<Input placeholder="Enter your last name" className="!placeholder-gray-300" {...field} />
									</FormControl>
									<FormMessage />
								</FormItem>
							)}
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormControl>
										<Input placeholder="Enter your email address" className="!placeholder-gray-300" {...field} />
									</FormControl>
									<FormMessage />
								</FormItem>
							)}
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormControl>
										<Input placeholder="Enter your mobile number" className="!placeholder-gray-300" {...field} />
									</FormControl>
									<FormMessage />
								</FormItem>
							)}
