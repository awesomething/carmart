  ...
  return (
    <>
      <div
        ref={dropRef}
        className={cn(
          "relative flex h-36 cursor-pointer flex-col items-center justify-center rounded-md border border-dashed border-primary",
      ...
      >
        ...
        >
          ...
          <p className="mb-1">
            ...
            <span className="ml-1 text-gray-500">or drag and drop</span>
          </p>
