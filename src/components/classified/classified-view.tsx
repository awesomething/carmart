...
export const ClassifiedView = (props: ClassifiedWithImagesAndMake) => {
    return (
        <div className="flex flex-col mx-auto px-12 md:px-0 py-12 bg-black">
            <div className="flex flex-col ml-6 md:flex-row ">
                <div className="md:w-1/2 ">
                    <ClassifiedCarousel images={props.images} />
                </div>
                <div className="md:w-1/2 md:pl-8 mt-4 md:mt-0 mr-6">
                    ...
                    <div className="text-3xl font-bold my-4 w-full border border-slate-200 flex justify-center items-center rounded-xl py-12">
                        Our Price:{" "}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        {features(props).map(({ id, icon, label }) => (
                            <div
                                key={id}
                                className="bg-gray-800 rounded-lg shadow-xs p-4 text-center flex items-center flex-col"
                            >
                                {icon}
