...
export const AdminSidebar = () => {
  ...
  return (
    <motion.div
      ...
      animate={isSidebarExtended ? "expanded" : "collapsed"}
          ...
          <div className="relative h-[60px] w-full">
            <AnimatePresence initial={false} mode="wait">
              {isSidebarExtended ? (
                ...
                >
                  <Image
                    alt="EazyDev Dealership Mobile logo"
                    src="/logo-mob2.png"
                    fill={true}
          ...
          {navigation.map((item) => {
            return (
              <ActiveLink
                href={item.href}
                key={item.name}
                className="flex items-center  text-white rounded-lg p-2 transition-colors duration-200 cursor-pointer w-full"
              >
