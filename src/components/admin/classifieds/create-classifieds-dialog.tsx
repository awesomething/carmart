...
import { StreamableSkeleton, StreamableSkeletonProps } from "./streamable-skeletons";
import { readStreamableValue, useActions, useUIState } from "ai/rsc";
import { AI } from "@/app/_actions/ai";
import { zodResolver } from "@hookform/resolvers/zod";
import { SubmitHandler, useForm } from "react-hook-form";
import { SingleImageSchema, SingleImageType } from "@/app/schemas/images.schema";
...
export const CreateClassifiedDialog = () => {
    ...
    return (
        <Dialog open={true} onOpenChange={() => null}>
            ...
            <DialogContent className={cn("max-w-6xl")}>
                <DialogHeader>
                ...
                <Form {...imageForm}>
                    ...
                    >
                        ...
                        <div className="flex justify-between gap-2" >
                            ...
                            <Button className="flex items-center gap-x-2"  type="submit" disabled={isUploading} >
