...
import { CarIcon, DollarSign, Percent, TrendingDownIcon, TrendingUpDown, TrendingUpIcon, UsersIcon } from 'lucide-react'
...
const KPICard = (props: DashboardItem[][number]) =>{
    ...
    return (
    <Card key={rest.id} className='bg-gray-800 broder-gray-700'>
        ...
        <CardContent className='flex items-center justify-between'>
            ...
            {rest.style === "currency" ? formatPrice({
                price: rest.amount, currency: "USD"
            })
            : 
            ...
            <p className={cn
                ...
                {rest.percentage === 0 ? `${rest.percentage}%`:
