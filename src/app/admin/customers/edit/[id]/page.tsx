...
export default async function EditCustomerPage(props: PageProps) {
  ...
  return (
    <>
      <div className="flex-col flex p-6 text-gray-500 space-y-4 container">
      ...
      <div className="container p-4 space-y-6">
        <div className="grid grid-cols-2 space-x-6">
          <Card className="bg-gray-900 border-gray-700">
            ...
            <CardContent className="grid gap-2 text-gray-500">
              <div>
        ...
        <Card className="bg-gray-900 border-gray-700">
          ...
          <CardContent className="grid gap-2 text-gray-500">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="text-gray-500 font-semibold text-base">
                    Date
                  </TableHead>
                  <TableHead className="text-gray-500 font-semibold text-base">
                    Old Status
              ...
              <TableBody>
                {customer.lifecycle.map((entry) => (
                  <TableRow className="text-gray-500/75" key={entry.id}>
                    <TableCell>
